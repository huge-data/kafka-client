...
public class MetadataTest {
	...
	public void tearDown() {
		assertNull("Exception in background thread : " + backgroundError.get(),
				backgroundError.get());
	}
	...
	public void testUpdateWithNeedMetadataForAllTopics() {
		...
		metadata.update(
				new Cluster(Collections.singletonList(new Node(0, "host1", 1000)), Arrays.asList(
						new PartitionInfo("topic", 0, null, null, null), new PartitionInfo(
								"topic1", 0, null, null, null)), Collections.<String> emptySet()),
				100);
	...
	public void testListenerGetsNotifiedOfUpdate() {
		...
		metadata.update(
				new Cluster(Arrays.asList(new Node(0, "host1", 1000)), Arrays.asList(
						new PartitionInfo("topic", 0, null, null, null), new PartitionInfo(
								"topic1", 0, null, null, null)), Collections.<String> emptySet()),
				100);
	...
	public void testListenerCanUnregister() {
		...
		metadata.update(
				new Cluster(Arrays.asList(new Node(0, "host1", 1000)), Arrays.asList(
						new PartitionInfo("topic2", 0, null, null, null), new PartitionInfo(
								"topic3", 0, null, null, null)), Collections.<String> emptySet()),
				100);
